...
describe('Add Transaction', () => {
    ...
    context('Unique Code', function () { 
        it('Input with Valid Data', function () {
            ...
            cy.contains('Mobil Diecast').click()
            cy.get('.btn').click()
...
const invoice1 = 'INV-011' //Update this variable before run test
const invoice2 = 'INV-012'
...
const qty1 = '2'
const qty2 = '3'
const uniquecode = 'GJK456' //Update this variable before run test
